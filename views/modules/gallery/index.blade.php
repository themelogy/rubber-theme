...
@section('breadcrumbs')
    @component('partials.title', ['breadcrumb'=>'gallery.index'])
        {{ trans('themes::gallery.title.gallery') }}
    @endcomponent
@endsection
            ...
            <div class="gdlr-core-pbf-wrapper " style="padding: 90px 0px 20px 0px;">
                <div class="gdlr-core-pbf-wrapper-content gdlr-core-js ">
                    <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
                                ...
                                <div class="gdlr-core-personnel-list-column  gdlr-core-column-20 gdlr-core-item-pdlr gdlr-core-item-mgb">
                                    <div class="gdlr-core-personnel-list clearfix">
                                        <div class="gdlr-core-personnel-list-image gdlr-core-media-image  gdlr-core-opacity-on-hover gdlr-core-zoom-on-hover">
                                            <a href="{{ $album->url }}"><img src="{{ $album->present()->firstImage(600,400,'fit',80) }}" alt="{{ $album->title }}"></a>
                                        </div>
                                        <div class="gdlr-core-personnel-list-content-wrap">
                                            <div class="gdlr-core-personnel-list-title gdlr-core-title-font"><a href="{{ $album->url }}">{{ $album->title }}</a></div>
                                            <div class="gdlr-core-personnel-list-position gdlr-core-info-font">{{ $album->category->title }}</div>
                                        </div>
                                    </div>
                                </div>
                                @endforeach
                        ...
                        {!! $albums->render('partials.pagination') !!}
                    </div>
                </div>
            </div>
        </div>
