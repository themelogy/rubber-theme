...
class HeaderMenuMobilePresenter extends Presenter
{
    /**
     * {@inheritdoc }.
     */
    ...
    {
        return PHP_EOL.'<ul id="menu-main-navigation" class="m-menu">'.PHP_EOL;
    }
     ...
     * {@inheritdoc }.
     */
    public function getActiveState($item, $state = ' class="menu-item menu-item-has-children current-menu-item"')
    {
        return $item->isActive() ? $state : ' class="menu-item menu-item-has-children"';
    }
