...
class HeaderMenuPresenter extends Presenter
{
    ...
    {
        return PHP_EOL.'<ul id="menu-main-navigation-1" class="sf-menu">'.PHP_EOL;
    }
     ...
     * {@inheritdoc }.
     */
    public function getActiveState($item, $state = ' class="menu-item current-menu-item"')
    {
        return $item->isActive() ? $state : ' class="menu-item"';
    }
    ...
    {
        return '<li class="menu-item menu-item-has-children realfactory-normal-menu '.$this->getActiveStateOnChild($item, ' current-menu-item').'">
		          <a href="'.$item->getUrl().'">
    ...
    {
        return '<li class="menu-item menu-item-has-children '.$this->getActiveStateOnChild($item, ' current-menu-item').'">
		          <a href="#">
					'.$item->getIcon().' '.$item->title.'
			      </a>
			      <ul class="sub-menu">
