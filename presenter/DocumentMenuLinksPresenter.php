<?php namespace Themes\Rubber\Presenter;

use Nwidart\Menus\Presenters\Presenter;

class DocumentMenuLinksPresenter extends Presenter
{
    /**
     * {@inheritdoc }.
     */
    ...
    {
        return '<li class=" gdlr-core-skin-divider gdlr-core-with-hover" style="border-color: #d8d8d8;margin-bottom: 3px;" '.$this->getActiveState($item).'><a href="'.$item->getUrl().'" '.$item->getAttributes().'><span class="gdlr-core-icon-list-icon-wrap"><i class="gdlr-core-icon-list-icon-hover icon_check_alt2" style="font-size: 16px;width: 16px;"></i><i class="gdlr-core-icon-list-icon icon_check_alt2" style="font-size: 16px;width: 16px;"></i></span><span class="gdlr-core-icon-list-content" style="font-size: 15px;">'.$item->getIcon().' '.$item->title.'</span></a></li>'.PHP_EOL;
    }
